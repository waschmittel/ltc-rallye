...
@PageTitle("Runners (Backup)")
@Route(value = "runnersbackup/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RouteAlias(value = "runnersbackup", layout = MainLayout.class)
@Uses(Icon.class)
public class RunnersViewBackup extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "runnersbackup/%s/edit";
    ...
    @Autowired
    public RunnersViewBackup(SamplePersonService samplePersonService) {
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(RunnersViewBackup.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(RunnersViewBackup.class);
            }
        }
    }
